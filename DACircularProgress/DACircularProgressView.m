...
@property(nonatomic, copy) DACircularProgressViewAnimationFinishedBlock animationFinishedBlock;
@end
...
- (void)   setProgress:(CGFloat)progress
          ...
          initialDelay:(CFTimeInterval)initialDelay
          withDuration:(CFTimeInterval)duration
animationFinishedBlock:(DACircularProgressViewAnimationFinishedBlock)animationFinishedBlock {
    [self  setProgress:progress
              animated:animated
          initialDelay:initialDelay
          withDuration:duration
          functionName:kCAMediaTimingFunctionEaseInEaseOut
animationFinishedBlock:animationFinishedBlock];
}
